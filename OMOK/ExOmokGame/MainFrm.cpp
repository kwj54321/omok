	...
	CCreateContext* pContext)
{
	...
	m_wndSplitter.CreateView(0, 0, RUNTIME_CLASS(CExOmokGameView), CSize(600, 710), pContext);
	m_wndSplitter.CreateView(0, 1, RUNTIME_CLASS(CLeftView), CSize(300, 710), pContext);
